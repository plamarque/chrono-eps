...
1. Une course a au moins un élève participant et au plus 20 élèves participants (mode individuel). En mode relais, une course a au moins 1 groupe et au plus 8 groupes ; les groupes sont nommés Groupe 1 à Groupe 8 par défaut ; 6 couleurs (chasubles) sont réutilisées cycliquement au-delà de 6 groupes. Chaque groupe relais a au moins un élève ; le premier groupe reçoit « Élève 1 » par défaut ; chaque nouveau groupe créé reçoit automatiquement un élève « Élève X » où X = N+1 et N est le nombre total de coureurs déjà engagés dans tous les groupes.

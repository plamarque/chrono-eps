...
1. **Chronomètre multi-élèves** — L'enseignant lance une course avec plusieurs élèves ; un chronomètre commun mesure le temps écoulé. En mode individuel, chaque coureur a un démarrage/arrêt individuel (Stop sur la carte = arrêt du chrono de ce coureur ; la carte reste visible sur fond gris avec temps affichés et bouton Start pour reprendre).
